...
const WithdrawRequests = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`${baseURL_PORTAL}report`, CONFIG).then(res => {
            ...
            if (res.data.Reports.length > 0) {  // looping  through the array for modifing the data
                for (let i = 0; i < res.data.Reports.length; i++) {
                    let new_date = { new_date: moment(res.data.Reports[i].created_on).format('DD-MM-YYYY') }
                    new_data.push(Object.assign(new_date, res.data.Reports[i]));
                }
                                      ...
                                      <div className="form-group">
                                          ...
                                          <div className="col-md-12">
                                              <input id="input" type="hidden
                                                            " className="form-control"
                                                  name="user" 
                                                  value={state.newUser} onChange={handleChangeUser} />
                                          </div>
                                      </div>
                                  </div>
                                  <div className="col-md-10-offset-1">
